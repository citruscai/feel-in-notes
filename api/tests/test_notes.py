...
def test_upload_unsupported_file_format(client,mock_mongo):
    """Testing the upload file method with unsupported file format"""
    ...
    ), "Expected a 400 response for unsupported file format"
